...
<head>
    <base href="../../../../">
    <meta charset="utf-8" />
    <title>Bleeding Star | Login</title>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{asset('')}}assets/media/logos/admin-logo.png" />
</head>
<!--end::Head-->
<!--begin::Body-->
            ...
            <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat"
                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-center mb-15">
                        <a href="#">
                            <img src="{{ asset('website') }}/assets/imgs/Logo.png" class="max-h-75px" alt="" />
                        </a>
                    </div>
                    <!--end::Login Header-->
