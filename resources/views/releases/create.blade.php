...
@section('section')
    <!--begin::Container-->
    <div class="container">
        <form action="{{ route('admin.releases.store') }}" method="POST" enctype="multipart/form-data" id="release-form">
            @csrf
            <!--begin::Card-->
            <div class="card card-custom mb-4">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Add Release</h3>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    ...
                                    @endif
                                    <span class="text-danger" id="release_image_error"></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <label>Name:</label>
                            <input type="text" name="release_name" id="release_name" class="form-control" value="{{ old('release_name') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control" readonly="readonly" name="release_date" value="{{ old('release_date') }}" required id="kt_datepicker_1" placeholder="Select Release Date" />
            ...
            <div class="card card-custom mb-4">
                ...
                <div class="card-body">
                   ...
                   <div class="row d-none" id="review-div">
            ...
            <!--end::Card-->
             ...
             <div class="card card-custom mb-4">
                ...
                <div class="card-body">
                   ...
                   <div class="row d-none" id="track-div">
                    <table class="table table-head-noborder table-responsive-sm purchase-table">
                        <thead>
                            <tr>
                                <th>image</th>
    ...
    <script>
        $('#release-form').submit(function(e) {
            ...
            if (document.getElementById("image").files.length == 0) {
                $('#release_image_error').text('Release Image is required');
                valid = false;
                if (!firstInvalidField) {
                    firstInvalidField = '#image';
                }
            } else {
                $('#release_image_error').text('')
            }
